...
export const INITIAL_STATE: QuestionnaireState = {
  ...
  yearsToSell: 10,
  sleep: "5-7 (Compromised)",
  mondayMeetings: "Yes, while weeping inside",
  imFine: "Hourly",
  gasStationSushi: "Never",
  energyDrinks: "1-3",
  termsAndConditions: "Never, I click and pray",
  familyChat: "Yes, with severe psychological scars",
  touchedGrass: "No, I have synthetic turf under my desk",
  exercise: "Does typing fast count?",
  stress: "Slightly vibrating",
